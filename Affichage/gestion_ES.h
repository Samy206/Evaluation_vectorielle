...
int generation_script_gnuplot(Gestion_ES * gestionnaire, char* file_name, Liste_vecteur *list); //Génération script lancement de gnuplot
int generation_fic_gnuplot(Gestion_ES * gestionnaire, char *file_name, Liste_vecteur * liste);    //Génération fichier de coordonnées gnup



int generation_fic_postscript(Gestion_ES * gestionnaire, char * filename, Liste_vecteur *list, statistiques statis); //génération fichier postscript ( écriture statistiques )
